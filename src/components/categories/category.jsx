      ...
      <div className="container mx-auto px-5 md:px-0 py-30">
        ...
        <div className="flex gap-6 flex-col md:flex-row">
          <div className="p-6 border-2 border-[#bfbfbf53] rounded-2xl bg-[#ffffff]">
            ...
            <button onClick={() => router.push('/books?category=story')} className="btn btn-primary btn-soft w-full text-[#155DFC] hover:text-[#ececec]">Explore Now</button>
          </div>
          <div className="p-6 border-2 border-[#bfbfbf53] rounded-2xl bg-[#ffffff]">
            ...
            <button onClick={() => router.push('/books?category=tech')} className="btn btn-primary btn-soft w-full text-[#155DFC] hover:text-[#ececec]">Explore Now</button>
          </div>
          <div className="p-6 border-2 border-[#bfbfbf53] rounded-2xl bg-[#ffffff]">
            ...
            <button onClick={() => router.push('/books?category=science')} className="btn btn-primary btn-soft w-full text-[#155DFC] hover:text-[#ececec]">Explore Now</button>
          </div>
        </div>
      </div>
    </div>
