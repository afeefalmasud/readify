...
const Hero = () => {
  return (
    <div className='bg-[#F8FAFC]'>
      <div className='container mx-auto flex justify-between items-center min-h-screen py-30'>
        <div className='mb-6'>
          ...
          <h1 className='text-[60px] font-bold text-[#0F172A] mb-6'>Find Your Next <br /> Great Read Today</h1>
